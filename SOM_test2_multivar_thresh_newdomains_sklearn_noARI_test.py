...
from mysom2_multivar_thresh_newdomains_sklearn_noARI_test import mysom2_multivar_thresh_newdomains_sklearn_noARI_test  # my own function for training the SOM on multiple variables, split in two to avoid time limit exceedence
...
#[varSOM, predictions, dataArrays, map_lats, map_lons, dataArray_train] = mysom2_multivar_thresh_newdomains_sklearn_noARI(myfiles, date_first, date_last, varnames, SOMsize, mapedges, myregion, d)
[varSOM, weights, predictions, dataArrays, map_lats, map_lons, dataArray_train] = mysom2_multivar_thresh_newdomains_sklearn_noARI_test(myfiles, date_first, date_last, varnames, SOMsize, mapedges, myregion, d)
...
#    plt.savefig('/scratch2/BMC/wrfruc/naegele/SOM_01H24Htrain_' + varnames[myvar] + '_' + SOMsize_str + '_thresh_ari' + ari + precip_duration1 + '_ari' + ari + precip_duration2 + '_' + date_first_str + '_' + date_last_str + '_' + myregion + '_test_newdomains_sklearn_cbar.png')#, bbox_inches='tight', pad_inches=0)
    plt.savefig('/scratch2/BMC/wrfruc/naegele/SOM_01H24Htrain_' + varnames[myvar] + '_' + SOMsize_str + '_thresh_ari' + ari + precip_duration1 + '_ari' + ari + precip_duration2 + '_' + date_first_str + '_' + date_last_str + '_' + myregion + '_test_newdomains_sklearn_noARI_lr975_6hr_test.png')#, bbox_inches='tight', pad_inches=0)
