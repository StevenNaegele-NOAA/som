...
import sys
import numpy as np
from mysom2_multivar_thresh_newdomains import mysom2_multivar_thresh_newdomains  # my own function for training the SOM on multiple variables, split in two to avoid time limit exceedence
...
if myregion == 'NW':
    ...
    maptedge = 500#550#500#530#1751
    mapbedge = 151#501#151#1#1059#3500
    mapledge = 551#1001#551#451#1751
    mapredge = 1500#1050#1500#1350#5250
elif myregion == 'SE':
    maptedge = 530#1751
...
#    plt.savefig('/scratch2/BMC/wrfruc/naegele/SOM_01H24Htrain_' + varnames[myvar] + '_' + SOMsize_str + '_thresh_ari' + ari + precip_duration1 + '_ari' + ari + precip_duration2 + '_' + date_first_str + '_' + date_last_str + '_' + myregion + '_test_newdomains_small.png')#, bbox_inches='tight', pad_inches=0)
    plt.savefig('/scratch2/BMC/wrfruc/naegele/SOM_01H24Htrain_' + varnames[myvar] + '_' + SOMsize_str + '_thresh_ari' + ari + precip_duration1 + '_ari' + ari + precip_duration2 + '_' + date_first_str + '_' + date_last_str + '_' + myregion + '_test_newdomains.png')#, bbox_inches='tight', pad_inches=0)
