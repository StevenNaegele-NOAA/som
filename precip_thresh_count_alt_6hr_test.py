...
date_first = date_first.strftime('%Y%m%d')[0:7+1] + '-00'
date_last = date_last.strftime('%Y%m%d')[0:7+1] + '-18'
...
print('datetimes_allvars[0] = ' + str(datetimes_allvars[0]))
print('datetimes_allvars[1] = ' + str(datetimes_allvars[1]))
...
with open('SOM_' + SOMsize_str + '_multivar_' + myregion + '_precip_thresh_count_ari' + ari + '_6hr_test.pkl', 'wb') as f:  # Python 2: open(..., 'w')
