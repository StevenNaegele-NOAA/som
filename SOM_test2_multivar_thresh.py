...
import sys
import numpy as np
from mysom2_multivar_thresh import mysom2_multivar_thresh  # my own function for training the SOM on multiple variables
...
#                ax_ = ax.contourf(map_lons, map_lats, np.transpose(varSOM_plot), cmap=my_var_cmap, vmin=my_var_vmin, vmax=my_var_vmax,
    ...
    plt.savefig('SOM_01H24Htrain_' + varnames[myvar] + '_' + SOMsize_str + '_thresh_ari' + ari + precip_duration1 + '_ari' + ari + precip_duration2 + '_' + date_first_str + '_' + date_last_str + '_' + myregion + '_test.png')#, bbox_inches='tight', pad_inches=0)
