...
myregion = 'SC'#'NW'#'NE'#'NC'#'NW'#'SW'#'SE'#'SC'#str(sys.argv[1])
...
with open('SOM_' + SOMsize_str + '_multivar_' + myregion + '_precip_thresh_count_ari' + ari + '_2021.pkl', 'wb') as f:  # Python 2: open(..., 'w')
