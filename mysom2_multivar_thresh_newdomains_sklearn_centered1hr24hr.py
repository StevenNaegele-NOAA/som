...
#            print('date_myvar = ' + date_myvar + ', current time = ' + str(datetime.datetime.now()))
            ...
            if myvar == 1:
                date_myvar_24hrcenteredon1hr = date_myvar + timedelta(hours=12)
#                datetimes_myvar.append(date_myvar)
...
#            year = myfiles[myvar][fileCount].split('/')[-1].split('.')[1][3:6 + 1]
                year = date_myvar_24hrcenteredon1hr.split('-')[0]
                month = date_myvar_24hrcenteredon1hr.split('-')[1]
                day = date_myvar_24hrcenteredon1hr.split('-')[2][0:1 + 1]
                hour = date_myvar_24hrcenteredon1hr.split('-')[2][3:4 + 1]
                datetimes_myvar.append(year + month + day + '-' + hour)
            else:
...
#                hour = myfiles[myvar][fileCount].split('/')[-1].split('.')[1][12:13 + 1]
                hour = myfiles[myvar][fileCount].split('/')[-1].split('_')[-1][8:9 + 1]
