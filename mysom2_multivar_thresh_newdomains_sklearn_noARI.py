...
def mysom2_multivar_thresh_newdomains_sklearn_noARI(myfiles, date_first, date_last, varnames, SOMsize, mapedges, myregion, d):
...
#    with open('/scratch2/BMC/wrfruc/naegele/SOM_' + SOMsize_str + '_thresh_ari' + ari + precip_duration1 + '_ari' + ari + precip_duration2 + '_' + varname_pickle + '_' + myregion + '_vars_batch_newdomains_sklearn_2020_2023.pkl', 'wb') as f:  # Python 2: open(..., 'w')
    with open('/scratch2/BMC/wrfruc/naegele/SOM_' + SOMsize_str + '_thresh_ari' + ari + precip_duration1 + '_ari' + ari + precip_duration2 + '_' + varname_pickle + '_' + myregion + '_vars_batch_newdomains_sklearn_2021_lr975_6hr.pkl', 'wb') as f:  # Python 2: open(..., 'w')
