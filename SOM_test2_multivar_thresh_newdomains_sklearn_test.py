...
#    plt.savefig('/scratch2/BMC/wrfruc/naegele/SOM_01H24Htrain_' + varnames[myvar] + '_' + SOMsize_str + '_thresh_ari' + ari + precip_duration1 + '_ari' + ari + precip_duration2 + '_' + date_first_str + '_' + date_last_str + '_' + myregion + '_test_newdomains_sklearn.png')#, bbox_inches='tight', pad_inches=0)
    plt.savefig('/scratch2/BMC/wrfruc/naegele/SOM_01H24Htrain_' + varnames[myvar] + '_' + SOMsize_str + '_thresh_ari' + ari + precip_duration1 + '_ari' + ari + precip_duration2 + '_' + date_first_str + '_' + date_last_str + '_' + myregion + '_test_newdomains_sklearn_cbar_test.png')#, bbox_inches='tight', pad_inches=0)
