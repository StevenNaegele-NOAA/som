...
def mysom2_multivar_thresh_newdomains_minisom(myfiles, date_first, date_last, varnames, SOMsize, mapedges, myregion, d):
...
#    dataArray_train = xr.DataArray(dataArray_train)#.to_masked_array(copy=False)
    dataArray_train = dataArray_train
...
#    with open('/scratch2/BMC/wrfruc/naegele/SOM_' + SOMsize_str + '_thresh_ari' + ari + precip_duration1 + '_ari' + ari + precip_duration2 + '_' + varname_pickle + '_' + myregion + '_vars_batch_newdomains_sklearn.pkl', 'wb') as f:  # Python 2: open(..., 'w')
    with open('/scratch2/BMC/wrfruc/naegele/SOM_' + SOMsize_str + '_thresh_ari' + ari + precip_duration1 + '_ari' + ari + precip_duration2 + '_' + varname_pickle + '_' + myregion + '_vars_batch_newdomains_minisom.pkl', 'wb') as f:  # Python 2: open(..., 'w')
